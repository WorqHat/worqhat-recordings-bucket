...
const subdomain = app.node.tryGetContext("worqhatSubdomain");
if (
    subdomain === undefined ||
  ...
  throw new Error(
      "Must pass a '-c worqhatSubdomain=<worqhat_subdomain>' context parameter"
  );
}
...
if (
  ...
  throw new Error(
      "Must pass a '-c worqhatSubdomain=<worqhat_subdomain> s3bucketName=<bucket_name> s3Region=<bucket region>' context parameter"
  );
}
